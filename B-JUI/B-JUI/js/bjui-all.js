    ...
    Datagrid.prototype.delRows = function(rows) {
        ...
        var doDel = function() {
            ...
            if (options.delUrl) {
                ...
                var type = options.delType, opts = {url:options.delUrl, data:(options.delPK ? [{ name:options.delPK, value:postData.join(',') }] : JSON.stringify(postData)), type:'POST', 

            :callback || function(json) { delEnd() }}
    ...
    Datagrid.prototype.resizeGrid = function() {
        ...
        var _resizeGrid = function() {
            var ww = that.$grid.width(), $headDiv = that.$tableH.next('.datagrid-thead-dialog-div'),
                newTemplate = ((that.options.tdTemplate && that.options.templateWidth) && that.options.templateWidth > ww) || that.options.dialogFilterW === 0
